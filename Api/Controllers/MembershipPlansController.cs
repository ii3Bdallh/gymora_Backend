...
namespace Api.Controllers
{
    ...
    public class MembershipPlansController(IMembershipPlanService service, ILogger<MembershipPlansController> logger) : ControllerBase
    {
        ...
        public async Task<ActionResult<Result<PaginatedRes<MembershipPlanRDTO>>>> GetPaged([FromBody] PaginatedSearchReq searchReq, CancellationToken ct = default)
        {
        ...
        [HttpGet("{id}")]
        [GymAuthorize]
        public async Task<ActionResult<Result<MembershipPlanRDTO>>> GetById(int id, CancellationToken ct = default)
        {
        ...
        public async Task<ActionResult<Result<MembershipPlanRDTO>>> Create([FromBody] MembershipPlanCDTO dto, CancellationToken ct = default)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        [HttpPut("{id}")]
        [GymAuthorize(GymRoleString.Owner, GymRoleString.Manager)]
        public async Task<ActionResult<Result<MembershipPlanRDTO>>> Update(int id, [FromBody] MembershipPlanUDTO dto, CancellationToken ct = default)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        [GymAuthorize(GymRoleString.Owner, GymRoleString.Manager)]
        public async Task<ActionResult<Result<MembershipPlanRDTO>>> Delete(int id, CancellationToken ct = default)
        {
