...
public interface IAuthRepo
{
    ...
    public Task<IUser?> GetUserByEmailAsync(string email, CancellationToken cancellationToken);

    public Task<string> GenerateEmailConfirmationTokenAsync(IUser user, CancellationToken cancellationToken = default);

    public Task<string> GenerateEmailConfirmationOtpAsync(IUser user, CancellationToken cancellationToken = default);
