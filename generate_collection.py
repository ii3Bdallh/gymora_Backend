...
FILTER_MAP = {
    ...
    "Revenues": {"search_term": "Fee", "order_by": "RevenueDate", "between_filters": '"Amount": {"min":"10.0","max":"1000.0"},"RevenueDate": {"min":"2026-01-01T00:00:00Z","max":"2026-12-31T23:59:59Z"}', "exact_filters": '"RevenueCategory": ["0"]'},
    "Expenses": {"search_term": "Rent", "order_by": "ExpenseDate", "between_filters": '"Amount": {"min":"10.0","max":"1000.0"},"ExpenseDate": {"min":"2026-01-01T00:00:00Z","max":"2026-12-31T23:59:59Z"}', "exact_filters": '"ExpenseCategory": ["0"]'},
    "Exercises": {"search_term": "Push", "order_by": "Name", "between_filters": "", "exact_filters": '"PrimaryMuscle": ["0"],"DifficultyLevel": ["0"],"IsApproved": ["true"]'},
    "Workout Plans": {"search_term": "Strength", "order_by": "PlanName", "between_filters": "", "exact_filters": '"IsApproved": ["true"]'},
    "Sessions": {"search_term": "Day", "order_by": "DayNumber", "between_filters": "", "exact_filters": '"DayNumber": ["1"],"IsApproved": ["true"]'},
    ...
    "Body Measurements": {"search_term": "Baseline", "order_by": "CreatedOn", "between_filters": '"WeightKg": {"min":"50.0","max":"120.0"}', "exact_filters": ""},
    ...
    "Member Workout Plans": {"search_term": "Goal", "order_by": "Id", "between_filters": '"StartDate": {"min":"2026-01-01T00:00:00Z","max":"2026-12-31T23:59:59Z"}', "exact_filters": '"Status": ["0"]'},
    "User Workout Blocks": {"search_term": "Violation", "order_by": "Id", "between_filters": '"BlockedUntil": {"min":"2026-01-01T00:00:00Z","max":"2026-12-31T23:59:59Z"}', "exact_filters": '"BlockedUserId": ["1"]'},
    "Session Exercises": {"search_term": "Bench", "order_by": "OrderIndex", "between_filters": "", "exact_filters": '"OrderIndex": ["0"]'},
